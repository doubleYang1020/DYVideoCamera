...
@protocol DYGPUImageMovieWriterDelegate <NSObject>
...
@interface DYGPUImageMovieWriter : NSObject <GPUImageInput>
{
...
@property(nonatomic, assign) id<DYGPUImageMovieWriterDelegate> delegate;
